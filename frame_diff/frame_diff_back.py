...
# Add arguments
parser.add_argument('--thresh', type=int, default=400, required=False, help='box size lower limit')
parser.add_argument('--video_path', type=str, default='highway_cut.mp4', required=True, help='video_path end with .mp4')
...
for idx in range(0, len(image_paths)):
    ...
    # get detections
    detections = get_detections(backSub, #knn
